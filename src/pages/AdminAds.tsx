...
import { ArrowLeft, Plus, Pencil, Trash2, Eye, Image, BarChart3, MousePointerClick, TrendingUp, Code, Megaphone } from "lucide-react";
      ...
      <header className="border-b border-border bg-card/50 backdrop-blur-sm sticky top-0 z-10 shrink-0">
        <div className="container mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-lg font-bold">Annonser</h1>
              <p className="text-xs text-muted-foreground">Hantera annonser</p>
            </div>
          </div>
        </div>
      </header>

      <main className="flex-1 overflow-y-auto overflow-x-hidden max-w-6xl mx-auto p-4 pb-24 space-y-6">
